(self["webpackChunkworld_cup_score_prediction"] = self["webpackChunkworld_cup_score_prediction"] || []).push([[6750],{
...
/* harmony import */ var _strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62791);
...
/* harmony import */ var _strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60985);
/* harmony import */ var _strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _strapi_icons_EmptyDocuments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(85407);
/* harmony import */ var _strapi_icons_EmptyDocuments__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_EmptyDocuments__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _strapi_icons_EmptyPermissions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(80775);
/* harmony import */ var _strapi_icons_EmptyPermissions__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_EmptyPermissions__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _strapi_icons_ExclamationMarkCircle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(51359);
/* harmony import */ var _strapi_icons_ExclamationMarkCircle__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_ExclamationMarkCircle__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _strapi_icons_EmotionUnhappy__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(64840);
/* harmony import */ var _strapi_icons_EmotionUnhappy__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_strapi_icons_EmotionUnhappy__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _hooks_useFormattedMessage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1041);
...
const wrapIcon = (icon) => /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  style: { fontSize: "6rem" }
}, icon);
const getIcon = (listDeployAvailability) => {
  switch (listDeployAvailability) {
    case "MISSING_CONFIG_OBJECT":
      return wrapIcon(/* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_ExclamationMarkCircle__WEBPACK_IMPORTED_MODULE_5___default()), null));
    case "MISSING_CONFIG_VARIABLE":
      return wrapIcon(/* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_EmptyPermissions__WEBPACK_IMPORTED_MODULE_4___default()), null));
    case "MISSING_DEPLOYMENTS":
      return wrapIcon(/* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_EmptyDocuments__WEBPACK_IMPORTED_MODULE_3___default()), null));
    case "ERROR_DEPLOYMENTS":
    case "ERROR_AVAILABILITY_GENERIC":
    case "ERROR_AVAILABILITY_FORBIDDEN":
    case "ERROR_CONFIG":
    default:
      return wrapIcon(/* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement((_strapi_icons_EmotionUnhappy__WEBPACK_IMPORTED_MODULE_6___default()), null));
  }
};
...
const DeploymentsEmptyState = ({ type }) => {
  ...
  const message = (0,_hooks_useFormattedMessage__WEBPACK_IMPORTED_MODULE_8__/* .useFormattedMessage */ .w)(messageId);
  const linkText = (0,_hooks_useFormattedMessage__WEBPACK_IMPORTED_MODULE_8__/* .useFormattedMessage */ .w)(
    "deployments-empty-state.missing-config-variable.link-text"
  );
  const action = type === "MISSING_CONFIG_VARIABLE" && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_LinkButton__WEBPACK_IMPORTED_MODULE_2__.LinkButton, {
    variant: "secondary",
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_EmptyStateLayout__WEBPACK_IMPORTED_MODULE_1__.EmptyStateLayout, {
    icon: getIcon(type),
    content: message,
    action
  });
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49425);
/* harmony import */ var _strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _hooks_useFormattedMessage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1041);



const FormattedMessage = ({ labelId, variant, textColor }) => {
  const label = (0,_hooks_useFormattedMessage__WEBPACK_IMPORTED_MODULE_2__/* .useFormattedMessage */ .w)(labelId);
  if (variant || textColor) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system_Typography__WEBPACK_IMPORTED_MODULE_1__.Typography, {
      variant,
      textColor
    }, label);
  }
...
var v2_Link = __webpack_require__(70677);
...
const getId = (msg) => typeof msg === "string" ? msg : (0,getTrad/* default */.Z)(msg == null ? void 0 : msg.id);
const getDefaultMessage = (msg) => {
  if (typeof msg === "string")
    return msg;
  return (msg == null ? void 0 : msg.defaultMessage) || (0,getTrad/* default */.Z)(msg == null ? void 0 : msg.id);
};
const Notification = ({ onClose: mainOnClose, notification }) => {
  ...
  return /* @__PURE__ */ react.createElement(Alert.Alert, {
    action: link ? /* @__PURE__ */ react.createElement(v2_Link.Link, {
      href: link.url,
      isExternal: true
    }, formatMessage({
      id: getId(link.label),
...
const Notifications = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(build.NotificationsProvider, {
    ...
    width: `${500 / 16}rem`,
    zIndex: 10
  }, notification && /* @__PURE__ */ react.createElement(Notifications_Notification, {
    key: notification.id,
    onClose,
    notification
  })), children);
...
const DeployButton = ({
  ...
  const runDeployHandler = () => __async(void 0, null, function* () {
    try {
      setHasDeployError(false);
      setIsLoading(true);
      const response = yield (0,api/* runDeploy */.ED)();
      if (onDeployed)
        onDeployed(false);
    } catch (error) {
  ...
  }, isLoading && /* @__PURE__ */ react.createElement(components_SymmetricBox, {
    paddingHorizontal: 4
  }, /* @__PURE__ */ react.createElement(Loader.Loader, {
    small: true
  }, labelLoader)), /* @__PURE__ */ react.createElement(components_SymmetricBox, {
    paddingHorizontal: 4
  }, /* @__PURE__ */ react.createElement(Button.Button, {
    onClick: runDeployHandler,
    disabled: !canDeploy || isLoading
  }, /* @__PURE__ */ react.createElement("div", {
    style: { display: "flex", alignItems: "center" }
  }, /* @__PURE__ */ react.createElement((Plus_default()), null), /* @__PURE__ */ react.createElement("span", {
    style: { width: "8px" }
  }), /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    labelId: "deploy-button.label"
  })))));
};
...
var DeploymentsEmptyState = __webpack_require__(41099);
...
const DeploymentsList = ({ deployments, usePolling }) => {
  ...
  return /* @__PURE__ */ react.createElement(Table.Table, {
    colCount: COL_COUNT,
    rowCount: ROW_COUNT
  }, /* @__PURE__ */ react.createElement(Table.Thead, null, /* @__PURE__ */ react.createElement(Table.Tr, null, /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    variant: headerFontVariant,
    labelId: "deployments-list.table-header.app-name"
  })), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    variant: headerFontVariant,
    labelId: "deployments-list.table-header.state"
  }), usePolling && /* @__PURE__ */ react.createElement(components_SymmetricBox, {
    paddingHorizontal: 2,
    paddingVertical: 0
  }, /* @__PURE__ */ react.createElement(Loader.Loader, {
    small: true
  }, labelLoader))), /* @__PURE__ */ react.createElement(Table.Th, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    variant: headerFontVariant,
    labelId: "deployments-list.table-header.creation-date"
  })), /* @__PURE__ */ react.createElement(Table.Th, null))), /* @__PURE__ */ react.createElement(Table.Tbody, null, deployments.map((entry) => /* @__PURE__ */ react.createElement(Table.Tr, {
    key: entry.uid
  }, /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, {
    textColor: cellTextColor
  }, entry.name)), /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Badge.Badge, {
    textColor: getStateColor(entry.state),
    backgroundColor: getStateBackgroundColor(entry.state)
  }, entry.state)), /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Typography.Typography, {
    textColor: cellTextColor
  }, getDate(entry.created))), /* @__PURE__ */ react.createElement(Table.Td, null, /* @__PURE__ */ react.createElement(Tooltip.Tooltip, {
    description: /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "deployments-list.table-body.visit-url-text"
    })
  }, /* @__PURE__ */ react.createElement(LinkButton.LinkButton, {
    href: entry.url,
    variant: "tertiary",
    style: { border: "none" }
  }, /* @__PURE__ */ react.createElement((ExternalLink_default()), null))), /* @__PURE__ */ react.createElement(Tooltip.Tooltip, {
    description: /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "deployments-list.table-body.inspect-url-text"
    })
  }, /* @__PURE__ */ react.createElement(LinkButton.LinkButton, {
...
const DeploymentsContainer = ({ usePolling, onDeploymentsFetched }) => {
  ...
  const hasEmptyDeployments = !deployments || (deployments == null ? void 0 : deployments.length) <= 0;
  if (isLoadingDeployments && hasEmptyDeployments) {
    return /* @__PURE__ */ react.createElement(Flex.Flex, {
      justifyContent: "center"
    }, /* @__PURE__ */ react.createElement(Loader.Loader, null, labelLoader));
  }
  if (hasDeploymentsError) {
    return /* @__PURE__ */ react.createElement(DeploymentsEmptyState/* default */.Z, {
      type: "ERROR_DEPLOYMENTS"
    });
  }
  if (hasEmptyDeployments) {
    return /* @__PURE__ */ react.createElement(DeploymentsEmptyState/* default */.Z, {
      type: "MISSING_DEPLOYMENTS"
    });
  }
  return /* @__PURE__ */ react.createElement(components_DeploymentsList, {
    deployments,
    usePolling
  });
};
...
const HomePage = () => {
  ...
  const canListDeploy = (availability == null ? void 0 : availability.listDeploy) == "AVAILABLE";
  const onDeployed = (hasError) => {
    if (hasError)
      return;
    setUseDeploymentsPolling(true);
  };
  return /* @__PURE__ */ react.createElement(components_Notifications, null, /* @__PURE__ */ react.createElement(Box.Box, {
    ...
    primaryAction: /* @__PURE__ */ react.createElement(components_DeployButton, {
      availabilityApiError: apiError,
      runDeployAvailability: availability == null ? void 0 : availability.runDeploy,
      onDeployed
    }),
    title: headerTitle,
    subtitle: headerSubtitle,
    as: "h2"
  })), /* @__PURE__ */ react.createElement(components_SymmetricBox, {
    paddingHorizontal: 10,
    paddingVertical: 2
  }, canListDeploy ? /* @__PURE__ */ react.createElement(components_DeploymentsContainer, {
    usePolling: useDeploymentsPolling,
    onDeploymentsFetched
  }) : /* @__PURE__ */ react.createElement(DeploymentsEmptyState/* default */.Z, {
    type: getDeploymentsEmptyStateType(
      apiError,
      availability == null ? void 0 : availability.listDeploy
    )
  })));
};
...
const ExternalLink = ({ href, children }) => {
  return /* @__PURE__ */ react.createElement("span", {
    style: { marginRight: "0.5em", marginLeft: "0.3em" }
...
const SettingsContainer = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(BoxField, {
    fieldName: "vercel-deploy-hook",
    fieldHint: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.deploy-hook.learn-more-intro"
    }), /* @__PURE__ */ react.createElement(components_ExternalLink, {
      href: "https://vercel.com/docs/git/deploy-hooks"
    }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.deploy-hook.learn-more-link-text"
    })))
  }, /* @__PURE__ */ react.createElement(Stack.Stack, null, /* @__PURE__ */ react.createElement(Field.FieldLabel, {
    required: true
  }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    labelId: "settings-page.deploy-hook.label"
  })), /* @__PURE__ */ react.createElement(Field.FieldInput, {
    type: "text",
    placeholder: deployHookPlaceholder,
    value: deployHook,
    disabled: true
  }), /* @__PURE__ */ react.createElement(Field.FieldHint, null))), /* @__PURE__ */ react.createElement(BoxField, {
    fieldName: "vercel-deploy-api-token",
    fieldHint: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.api-token.learn-more-intro"
    }), /* @__PURE__ */ react.createElement(components_ExternalLink, {
      href: "https://vercel.com/account/tokens"
    }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.api-token.learn-more-link-text"
    })))
  }, /* @__PURE__ */ react.createElement(Stack.Stack, null, /* @__PURE__ */ react.createElement(Field.FieldLabel, {
    required: true
  }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    labelId: "settings-page.api-token.label"
  })), /* @__PURE__ */ react.createElement(Field.FieldInput, {
    type: "text",
    ...
    fieldHint: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.app-name.learn-more-intro"
    }), /* @__PURE__ */ react.createElement(components_ExternalLink, {
      href: "https://vercel.com/dashboard"
    }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.app-name.learn-more-link-text"
    })), /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.app-name.learn-more-outro"
    }))
  }, /* @__PURE__ */ react.createElement(Stack.Stack, null, /* @__PURE__ */ react.createElement(Field.FieldLabel, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    labelId: "settings-page.app-name.label"
  })), /* @__PURE__ */ react.createElement(Field.FieldInput, {
    type: "text",
    ...
    fieldHint: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.team-id.learn-more-intro"
    }), /* @__PURE__ */ react.createElement(components_ExternalLink, {
      href: "https://vercel.com/dashboard"
    }, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.team-id.learn-more-link-text"
    })), /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
      labelId: "settings-page.team-id.learn-more-outro"
    }))
  }, /* @__PURE__ */ react.createElement(Stack.Stack, null, /* @__PURE__ */ react.createElement(Field.FieldLabel, null, /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, {
    labelId: "settings-page.team-id.label"
  })), /* @__PURE__ */ react.createElement(Field.FieldInput, {
    type: "text",
...
const SettingsPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Box.Box, {
    ...
    subtitle: headerSubtitle,
    as: "h2"
  })), /* @__PURE__ */ react.createElement(SettingsContainer, null));
};
...
const SettingsApp = () => {
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(react_router_dom_min.Switch, null, /* @__PURE__ */ react.createElement(react_router_dom_min.Route, {
    path: `/settings/${(pluginId_default())}`,
...
const runDeploy = () => api_async(void 0, null, function* () {
  try {
    const data = yield axiosInstance(`/${(pluginId_default())}/deploy/run`, { method: "GET" });
    return data.data;
  } catch (error) {
...
const getConfig = () => api_async(void 0, null, function* () {
  try {
    const response = yield axiosInstance(`/${(pluginId_default())}/config`, { method: "GET" });
...
const getDeployments = () => api_async(void 0, null, function* () {
  try {
    const response = yield axiosInstance(`/${(pluginId_default())}/deploy/list`, { method: "GET" });
    return response.data;
  } catch (error) {
    console.error(
...
const deployAvailability = () => api_async(void 0, null, function* () {
  try {
    const response = yield axiosInstance(`/${(pluginId_default())}/deploy/availability`, {
      method: "GET"
    });
    return response.data;
  } catch (error) {
